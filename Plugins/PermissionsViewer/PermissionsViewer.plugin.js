            ...
            for (const r in displayRoles) {
                ...
                item.addEventListener("contextmenu", (e) => {
                    DCM.openContextMenu(e, DCM.buildMenu([
                        {label: StringsModule.COPY_ID, action: () => {DiscordModules.ElectronModule.copy(role);}}
                    ]));
                });
            }
